            ...
            try:
                ...
                if duration <= 0:
                    ...
                    for idx in matched_indices:
                        all_results.append({"Log_Name": log_name, "Timestamp": times[idx], "Signal": matched_signal, "Value": values[idx]})
                else:
                    ...
                    for i, is_true in enumerate(bool_arr):
                        ...
                        if is_true and not in_block:
                            ...
                            if (block_end_t - block_start_t) > duration:
                                all_results.append({"Log_Name": log_name, "Timestamp": block_start_t, "Signal": matched_signal, "Duration": block_end_t - block_start_t})
